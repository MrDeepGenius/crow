...
export const cardStyle: React.CSSProperties = {
  background: `linear-gradient(135deg, rgba(124,58,237,0.06) 0%, rgba(124,58,237,0) 50%), ${C.card}`,
...
.aff-card { transition: transform 0.22s cubic-bezier(0.4,0,0.2,1), border-color 0.22s ease, box-shadow 0.22s ease; }
.aff-card:hover { transform: translateY(-3px); border-color: rgba(124,58,237,0.4); box-shadow: 0 16px 40px rgba(124,58,237,0.15), 0 0 0 1px rgba(124,58,237,0.08); }
.aff-btn { transition: filter 0.15s ease, transform 0.15s ease, background 0.15s ease, box-shadow 0.15s ease; }
...
.aff-navitem { transition: background 0.18s ease, color 0.18s ease, box-shadow 0.18s ease, padding-left 0.18s ease; }
.aff-navitem:hover { background: rgba(124,58,237,0.08) !important; padding-left: 16px !important; }
.aff-fadein { animation: affFade 0.4s cubic-bezier(0.4,0,0.2,1) both; }
@keyframes affFade { from { opacity: 0; transform: translateY(8px); } to { opacity: 1; transform: none; } }
...
.aff-premium-scroll::-webkit-scrollbar { width: 6px; }
.aff-premium-scroll::-webkit-scrollbar-track { background: transparent; }
.aff-premium-scroll::-webkit-scrollbar-thumb { background: rgba(124,58,237,0.3); border-radius: 10px; }
.aff-premium-scroll::-webkit-scrollbar-thumb:hover { background: rgba(124,58,237,0.5); }
.aff-glow-pulse { animation: affGlowPulse 3s ease-in-out infinite; }
@keyframes affGlowPulse { 0%, 100% { box-shadow: 0 0 20px rgba(124,58,237,0.2); } 50% { box-shadow: 0 0 36px rgba(124,58,237,0.35); } }
@media (prefers-reduced-motion: reduce) {
  .aff-card, .aff-btn, .aff-fadein, .aff-skeleton::after, .aff-toast, .aff-draw, .aff-glow-pulse { animation: none !important; transition: none !important; }
}
`;
