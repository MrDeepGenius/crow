// POST /api/licenses/order — crea orden de LICENCIA (sesión requerida)
// Precio fijado por el SERVIDOR desde el catálogo (nunca del body).
// Reutiliza quote/verify existentes: la orden es una orden DB normal con
// orderType='license'. Sin comisiones de afiliados (van al Rewards Pool).
