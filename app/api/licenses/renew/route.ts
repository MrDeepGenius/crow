// POST /api/licenses/renew — renovar licencia (crea orden de pago)
// El precio lo fija el servidor desde el catálogo. La licencia se activa
// tras pago confirmado (settlePaidOrder → activateLicense).
