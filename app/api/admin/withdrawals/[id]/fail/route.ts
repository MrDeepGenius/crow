...
import { failWithdrawal } from "@/app/services/withdrawals/withdrawalService";

export const dynamic = "force-dynamic";

// POST /api/admin/withdrawals/[id]/fail — marcar retiro como fallido
export async function POST(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  const result = failWithdrawal(id, reason || "Transferencia fallida", actor);
